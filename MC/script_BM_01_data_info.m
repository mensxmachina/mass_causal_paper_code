...
inhibitorFolders = {inhibitorFolders(5:end-1).name};
...
nEightDonorPopulations = length(eightDonorPopulations);
nTimePoints = length(timePoints);

% General populations: monocytes, T-cells, dendritic cells, B-cell, natural
% killer cells.
...
fprintf(logFid, '\n=======================================================================================\n');
fprintf(logFid, '                 Finished %s, time elapsed %.3f                   \n', mfilename, toc(strTic));
fprintf(logFid, '\n=======================================================================================\n');
