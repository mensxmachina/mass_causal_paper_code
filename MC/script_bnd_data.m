...
activatorIDs = {'BCR', 'Flt3L', 'GCSF', 'GMCSF', 'IFNa', 'IL3', 'IL7', 'LPS', 'PMAiono', 'PVO4'};
activators = {'BCR', 'Flt3L', 'GCSF', 'GMCSF', 'IFNa', 'IL3', 'IL7', 'LPS', 'PMA-IONO', 'PVO4'};
...
populationIDS = {'CD11b- Monocyte', 'CD11bhi Monocyte', 'CD11bmid Monocyte', 'NK',  'Mature CD4+ T', 'Naive CD4+ T', 'Naive CD8+ T', ...
    'Mature CD8+ T', 'Pre-B II', 'Mature CD38lo B', 'Pre-B I', 'Mature CD38mid B', 'Immature B', 'Plasmacytoid DC'};

populations = {'monocyte_cd11b-', 'monocyte_cd11bhi', 'monocyte_cd11bmid', 'nk',  'mature_cd4+t', 'naive_cd4+t', 'mature_cd8+t', ...
    'naive_cd8+t', 'pre-bII', 'pre-bI', 'mature_CD38lo_b', 'mature_CD38mid_b', 'immature_b', 'dc'};

% General populations: monocytes, T-cells, dendritic cells, B-cell, natural killer cells.
isMonocyte = false(1, 14); isMonocyte (1:3)=true;
isTcell = false(1, 14); isTcell(5:8)= true;
isDendritic = false(1, 14); isDendritic(14) = true;
isBcell= false(1, 14); isBcell(9:13)= true;
isNk = false(1, 14); isNk(4)=true;


% Syk is measured instead of pZap70 in monocytes/dendritic/b-cells. This matrix 
% is used to correct the headers.
